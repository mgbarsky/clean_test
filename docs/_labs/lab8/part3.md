# Lab 8 -- Million Monkeys with Typewriters
## Part 3 -- Text Generation Examples

(You don't have to do anything for this part. These are just example outputs from [Part 2](part2.html).)

### Example from _As you Like It_
...
### Example from _Buffy the Vampire Slayer_ using order 12 model
